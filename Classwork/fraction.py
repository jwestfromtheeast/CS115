class Fraction(object):
    ...
    '''
    # Encapsulation: The enclosing of member variables and methods
    # inside the class definition so that everything needed to represent
    # and modify your object value is inside the class.
    # Operator overloading is when you implement specific methods
    # such as __eq__, __ne__, __add__ to give meaning to operators
    # such as ==, !=, +, inside your code.
